...
class GasProfile:
    ...
    def f_ICM(self):
        ...
        return (self._Om_b/self._Om_m - self.f_star()) / (1 + (M_c/self._M_200c)**beta)
    ...
    def f_ej(self):
        ...
        of mass M_200c
        '''
        return (self._Om_b/self._Om_m) - self.f_star() - self.f_ICM()
    ...
    def get_A(self):
        ...
        A = self._M_200c * self.f_ICM() * 1/(4*np.pi) * integral**(-1)
    ...
    def Delta_T(self, aperture_radii, A):
        ...
        def I1(theta):
            ...
            return np.trapz(integrand_values, l_values)
        ...
        def I2(start, stop):
            ...
            return np.trapz(f1d_values, theta_values)
